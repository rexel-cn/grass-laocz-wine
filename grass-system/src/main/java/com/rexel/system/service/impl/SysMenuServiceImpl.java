...
import com.rexel.system.domain.vo.MetaVO;
import com.rexel.system.domain.vo.RouterVO;
import com.rexel.system.mapper.SysMenuMapper;
...
public class SysMenuServiceImpl implements ISysMenuService {
    ...
    public List<RouterVO> buildMenus(List<SysMenu> menus) {
        ...
        for (SysMenu menu : menus) {
            ...
            router.setMeta(new MetaVO(menu.getMenuName(), menu.getIcon(), StringUtils.equals("1", menu.getIsCache()), menu.getPath(), menu.getNavNoShow()));
            ...
            if (!cMenus.isEmpty() && cMenus.size() > 0 && UserConstants.TYPE_DIR.equals(menu.getMenuType())) {
                ...
                children.setMeta(new MetaVO(menu.getMenuName(), menu.getIcon(), StringUtils.equals("1", menu.getIsCache()), menu.getPath(), menu.getNavNoShow()));

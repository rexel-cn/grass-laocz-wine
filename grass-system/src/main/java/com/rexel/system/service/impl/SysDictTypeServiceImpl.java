...
import com.rexel.common.core.domain.entity.SysDictType;
...
import com.rexel.system.mapper.SysDictTypeMapper;
...
public class SysDictTypeServiceImpl implements ISysDictTypeService {
     ...
     *
     * @param dictType
     * @param b        true= key :DictValue,V:DictLabel,！！！！！！null||false=k:DictLabel,v:DictValue
     * @return
     */
    @Override
    public Map<String, String> selectDictMapByType(String dictType, Boolean b) {
        List<SysDictData> sysDictData = selectDictDataByType(dictType);
        if (ObjectUtil.isNull(b) || !b) {

package com.rexel.common.utils.poi;

import com.alibaba.excel.EasyExcel;
import com.rexel.common.annotation.Excel;
import com.rexel.common.annotation.Excels;
...
import com.rexel.common.utils.file.FileTypeUtils;
import com.rexel.common.utils.file.FileUtils;
import com.rexel.common.utils.file.ImageUtils;
import com.rexel.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T> {
    ...
    private static void setResponse(HttpServletResponse response, String sheetName) throws IOException {
        ...
        //时间戳+文件名导出
        FileUtils.setAttachmentResponseHeader(response, timestampFilename(sheetName));
    }
     ...
     * @throws IOException
     */
    public static void dynamicHeadWrite(HttpServletResponse response, List<List<String>> head, List<List<String>> data, String sheetName) throws IOException {
            ...
            for (int i = titleNum + 1; i <= rows; i++) {
                ...
                for (Map.Entry<Integer, Field> entry : fieldsMap.entrySet()) {
                    ...
                    if (StringUtils.isNotNull(fieldType)) {
                        ...
                        } else if (!attr.handler().equals(com.rexel.common.utils.poi.ExcelHandlerAdapter.class)) {
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = GrassServerConfig.getDownloadPath() + filename;
     ...
     * @return 结果
     */
    public AjaxResult exportEasyExcel(HttpServletResponse response, List<T> list, String sheetName) throws IOException {
        setResponse(response, sheetName);
        EasyExcel.write(response.getOutputStream())
                // 这里放入动态头
                .sheet(sheetName)

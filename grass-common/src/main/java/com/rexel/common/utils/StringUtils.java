...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    /**
     * 汉字替换成数字，MessageFormat可用
     * {用户名}您好！于{报警时间},{物料名称}{判断条件}{报警阈值},达到{批号时间},请相关人员注意!  {汉字}=>{0}
     *
     * @return
     */
    public static String canBeFormatted(String str) {
        String regex = "\\{[\\u4e00-\\u9fa5].*?\\}";
        Pattern p = Pattern.compile(regex);
        //str="{用户名}您好！于{报警时间},{物料名称}{判断条件}{报警阈值},达到{批号时间},请相关人员注意!";

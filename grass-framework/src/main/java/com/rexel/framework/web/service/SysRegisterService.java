package com.rexel.framework.web.service;//package com.rexel.framework.web.service;
//
...
////                msg = "注册失败,请联系系统管理人员";
////            } else {
////                AsyncManager.me().execute(AsyncFactory.recordLogininfor(username,null, Constants.REGISTER,

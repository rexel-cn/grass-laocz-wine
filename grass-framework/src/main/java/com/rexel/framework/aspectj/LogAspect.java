package com.rexel.framework.aspectj;

import com.alibaba.fastjson2.JSON;
import com.rexel.common.annotation.Log;
import com.rexel.common.core.domain.model.LoginUser;
import com.rexel.common.enums.BusinessStatus;
import com.rexel.common.enums.HttpMethod;
...
public class LogAspect {
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult) {
        try {
            ...
            SysOperLogFramework operLog = new SysOperLogFramework();
            ...
            AsyncTtlManager.me().execute(AsyncFactory.recordOper(operLog));
        } catch (Exception exp) {
            // 记录本地异常日志
            log.error("==前置通知异常==");
     ...
     * @param operLog 操作日志
     */
    public void getControllerMethodDescription(JoinPoint joinPoint, Log log, SysOperLogFramework operLog, Object jsonResult) {
        // 设置action动作
     ...
     * @param operLog 操作日志
     */
    private void setRequestValue(JoinPoint joinPoint, SysOperLogFramework operLog) {

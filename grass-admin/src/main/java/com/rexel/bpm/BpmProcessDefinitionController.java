...
import com.rexel.bpm.convert.definition.BpmProcessDefinitionConvert;
import com.rexel.common.utils.PageResult;
import com.rexel.bpm.domain.dal.BpmProcessDefinitionInfoDO;
import com.rexel.bpm.domain.vo.model.BpmProcessDefinitionPageReqVO;
...
public class BpmProcessDefinitionController extends BaseController {
    ...
    public TableDataInfo getProcessDefinitionPage(BpmProcessDefinitionPageReqVO pageReqVO) {
        ...
        PageResult<BpmProcessDefinitionRespVO> bpmProcessDefinitionRespVOPageResult = BpmProcessDefinitionConvert.INSTANCE.buildProcessDefinitionPage(
                pageResult, deploymentMap, processDefinitionMap);
        return getDataTable(bpmProcessDefinitionRespVOPageResult.getList(),bpmProcessDefinitionRespVOPageResult.getTotal());
    }
    ...
    public AjaxResult getProcessDefinitionList(
        ...
        return success(BpmProcessDefinitionConvert.INSTANCE.buildProcessDefinitionList(
                list, null, processDefinitionMap));
    }
    ...
    public AjaxResult getProcessDefinition(
        ...
        return success(BpmProcessDefinitionConvert.INSTANCE.buildProcessDefinition(
                processDefinition, null, null, bpmnModel));
    }

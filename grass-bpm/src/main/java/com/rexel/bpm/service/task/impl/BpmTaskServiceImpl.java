...
//        Task task = validateTask(userId, reqVO.getId());
//        if (task.isSuspended()) {
//            throw new CustomException("当前任务处于挂起状态，不能操作");
//        }
...
//            throw new CustomException("任务委派失败，委派人和当前审批人为同一人");
//        }
//        // 1.2 校验目标用户存在
//        AdminUserRespDTO delegateUser = adminUserApi.getUser(reqVO.getDelegateUserId());
//        if (delegateUser == null) {
//            throw new CustomException("任务委派失败，被委派人不存在");
//        }
//
//        // 2. 添加委托意见

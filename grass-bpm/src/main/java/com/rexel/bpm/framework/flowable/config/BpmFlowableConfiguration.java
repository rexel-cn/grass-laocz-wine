package com.rexel.bpm.framework.flowable.config;


import cn.hutool.core.collection.ListUtil;
import com.rexel.bpm.framework.flowable.core.behavior.BpmActivityBehaviorFactory;
import com.rexel.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
...
public class BpmFlowableConfiguration {
    ...
    public BpmTaskCandidateInvoker bpmTaskCandidateInvoker(List<BpmTaskCandidateStrategy> strategyList,
        ...
        return new BpmTaskCandidateInvoker(strategyList, iSysUserService);
    }

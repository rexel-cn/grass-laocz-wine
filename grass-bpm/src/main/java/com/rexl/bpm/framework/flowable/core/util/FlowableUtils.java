package com.rexl.bpm.framework.flowable.core.util;

import com.rexel.tenant.context.TenantContextHolder;
import com.rexl.bpm.framework.flowable.core.enums.BpmConstants;
...
public class FlowableUtils {
    ...
    public static String getTenantId() {
        ...
        return tenantId != null ? tenantId : ProcessEngineConfiguration.NO_TENANT_ID;
    }

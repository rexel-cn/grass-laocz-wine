package com.rexl.bpm.framework.flowable.config;


import cn.hutool.core.collection.ListUtil;
import com.rexel.user.ISysUserServiceFrameworkApi;
import com.rexl.bpm.framework.flowable.core.behavior.BpmActivityBehaviorFactory;
import com.rexl.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import com.rexl.bpm.framework.flowable.core.candidate.BpmTaskCandidateStrategy;
import com.rexl.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
...
public class BpmFlowableConfiguration {
    ...
    public BpmTaskCandidateInvoker bpmTaskCandidateInvoker(List<BpmTaskCandidateStrategy> strategyList,
                                                           ISysUserServiceFrameworkApi adminUserApi) {

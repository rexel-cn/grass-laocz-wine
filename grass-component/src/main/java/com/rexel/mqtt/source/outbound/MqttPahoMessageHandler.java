...
import com.rexel.mqtt.source.core.DefaultMqttPahoClientFactory;
import com.rexel.mqtt.source.core.MqttPahoClientFactory;
import com.rexel.mqtt.source.core.MqttPahoComponent;
import com.rexel.mqtt.source.event.MqttConnectionFailedEvent;
import com.rexel.mqtt.source.event.MqttMessageDeliveredEvent;
import com.rexel.mqtt.source.event.MqttMessageSentEvent;
...
import com.rexel.mqtt.source.support.MqttUtils;
...
public class MqttPahoMessageHandler extends AbstractMqttMessageHandler<IMqttAsyncClient, MqttConnectOptions>
    ...
    private IMqttAsyncClient checkConnection() throws MqttException {
        this.lock.lock();
        try {
            ClientManager<IMqttAsyncClient, MqttConnectOptions> theClientManager = getClientManager();
